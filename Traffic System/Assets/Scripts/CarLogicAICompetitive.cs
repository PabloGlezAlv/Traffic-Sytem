...
public enum behaviours { normal, sleepy, insecure, competitive}

public class CarLogicAICompetive : Agent, IMovable
{
    [SerializeField]
    behaviours CarType;
    ...
    public override void OnActionReceived(ActionBuffers actions)
    {
        ...
        switch (moveInput)
        {
            ...
            case 1: moveInput = driverSpeed * 0.33f; break;
            case 2: moveInput = driverSpeed * 0.66f; break;
            case 3: moveInput = driverSpeed; break;
            default: break;
        }
        //---------------------------------------------
